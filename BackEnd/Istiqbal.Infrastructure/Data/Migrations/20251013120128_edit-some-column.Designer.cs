...
namespace Istiqbal.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251013120128_edit-some-column")]
    partial class editsomecolumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Istiqbal.Domain.Guests.Reservations.Reservation", b =>
                {
                    ...
                    b.Property<decimal>("MaxOccupancy")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Istiqbal.Domain.Rooms.Room", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Number"), 100L);
